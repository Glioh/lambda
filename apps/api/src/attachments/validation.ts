import { ACCEPTED_IMAGE_TYPES, MAX_ATTACHMENT_BYTES, MAX_ATTACHMENTS_PER_MESSAGE, MAX_BASE64_CHARS, MAX_TOTAL_ATTACHMENT_BYTES, type AttachmentInput, } from "@lambda/api-contracts";
